    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5" id="exampleModalLabel">Print Semua Surat Keluar</h5>
                    ...
                    <div class="row justify-content-center text-center m-4">
                        <table border="1" class="table table-bordered table-sm">
                            <thead class="text-center">
                                ...
                                <tr>
                                    <th colspan="10"><strong>Report Surat Keluar</strong></th><br>
                                </tr>
                                <tr>
                                    <th colspan="10"><strong>Created By {{ auth()->user()->name }}</strong></th><br>
                                </tr>
                                <tr>
                                    <th colspan="10" class="pb-5"><span id="date_time"></span></th>
                                </tr>
                            </thead>
                            <thead>
                                <tr class="text-dark pt-5">
