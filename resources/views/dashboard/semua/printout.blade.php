<div class="modal fade" id="printout" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                    ...
                    <div class="row justify-content-center text-center mx-2">
                        <table border="1" class="table table-bordered table-sm">
                            <thead class="text-center">
                                ...
                                <tr>
                                    <th colspan="11"><strong>Report All Surat Keluar</strong></th><br>
                                </tr>
                                <tr>
            ...
            <div class="modal-footer">
                <a href="/dashboard/semua" class="btn btn-sm btn-danger">
