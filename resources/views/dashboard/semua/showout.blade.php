...
@section('content')
    <div id="layoutSidenav" class="m-3">
        <div id="layoutSidenav_content">
            ...
            <a href="/admin/surat/keluar/{{ $keluar->id }}/edit" target="_blank"
                class="btn btn-outline-secondary btn-sm m-1"><i class="bi bi-printer-fill"></i> <strong>Print</strong>
            </a>
            ...
            <div class="card shadow border-bottom-primary my-3">
                <div class="card-header p-0">
                    <a href="#suratkeluar" class="d-block card-header" data-toggle="collapse" role="button"
                        ...
                        <h2 class="m-0 font-weight-bold text-dark"><strong>S</strong>urat <strong>K</strong>eluar
                            <strong>T</strong>ujuan
                            {{ $keluar->tujuan }}</h2>
                    </a>
                </div>
  ...
  <div class="modal-dialog modal-xl">
      <div class="modal-content">
                  ...
                  <div class="col-md-5">
                      <div class="card card-info">
                          <div class="card-header">
                              <h3 class="card-title">Detail Arsip Surat keluar</h3>
                          </div>
          ...
          <div class="modal-footer">
              <a href="/dashboard/semua/keluar" class="btn btn-sm btn-danger">
                  <i class="bi bi-arrow-left"></i> Kembali
              </a>

              <a class="no-print btn btn-secondary btn-sm" href="javascript:print1keluar('print-1');"><i
